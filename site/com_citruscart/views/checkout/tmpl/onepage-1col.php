					...
					<div class="citruscart-expanded" id="coupon-pane">
						<div id="coupon_code_area">
			            	...
			            	<?php if( $enable_tooltips ) : ?>
		            			...
		            			<input type="button" class="btn btn-default" name="coupon_submit" value="<?php echo JText::_('COM_CITRUSCART_ADD_COUPON_TO_ORDER'); ?>"  onClick="CitruscartAddCoupon( document.adminForm, '<?php if ($mult_enabled) { echo "1"; } else { echo "0"; } ?>' );"/>
		            		</div>
