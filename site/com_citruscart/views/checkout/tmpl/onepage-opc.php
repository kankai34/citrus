		...
		<div class="opc-review-place-order">
			<div class="inner col3">
				...
				<div id="citruscart_btns">
					<input type="button" class="btn citruscart_checkout_order" onclick="citruscartSaveOnepageOrder('citruscart_checkout_pane', 'validationmessage', this.form )" value="<?php echo JText::_('COM_CITRUSCART_CLICK_HERE_TO_CONTINUE'); ?>" />
					<div class="reset marginbot"></div>
