...
<form id="opc-billing-form" name="opc-billing-form" action="" method="post">
    ...
    <fieldset id="existing-billing-addresses">
        <select id="existing-billing-address" name="billing_address_id">
            ...
            <?php } ?>
            <option id="create-new-billing-address" value="0"><?php echo JText::_( "COM_CITRUSCART_NEW_ADDRESS" ); ?></option>
        </select>
    </fieldset>
    <?php } ?>
        ...
        <ul class="unstyled control-group">
            <li class="control">
                <label for="<?php echo $this->form_prefix; ?>use_for_shipping_yes" class="radio">
                    ...
                    <?php echo JText::_('COM_CITRUSCART_SHIP_TO_THIS_ADDRESS'); ?>
                </label>
            </li>
            ...
            <li class="control">
                <label for="<?php echo $this->form_prefix; ?>use_for_shipping_no" class="radio">
                    ...
                    <?php echo JText::_( "COM_CITRUSCART_SHIP_TO_DIFFERENT_ADDRESS" ); ?>
                </label>
            </li>
        </ul>
    	<?php } ?>
    ...
    <a id="opc-billing-button" class="btn btn-primary"><?php echo JText::_('COM_CITRUSCART_CONTINUE') ?></a>
