...
<thead>
<tr>
    <th colspan="5" style="background-color:#FF9B13;"><span style="color:#FFFFFF;"><?php echo JText::_('COM_CITRUSCART_SUMMARY_STATISTICS'); ?></span></th>
</tr>
</thead>
<tbody>
<tr>
...
<tr>
	...
	<td style="text-align: right;"><label class="label label-warning"><?php echo CitruscartHelperBase::currency( $stats->today->average,'', $options_decimal ); ?></label></td>
...
<tr>
	...
	<td style="text-align: right;">&nbsp</td>
	<td style="text-align: right;"><label class="label label-warning"><?php echo CitruscartHelperBase::currency( $stats->yesterday->average,'', $options_decimal ); ?></label></td>
...
<tr>
	...
	<td style="text-align: right;"><label class="label label-warning"><?php echo CitruscartHelperBase::currency( $stats->lastseven->average,'', $options_decimal ); ?></label></td>
...
<tr>
	...
	<td style="text-align: right;"><label class="label label-warning"><?php echo CitruscartHelperBase::currency( $stats->lastmonth->average,'', $options_decimal ); ?></label></td>
...
<tr>
	...
	<td style="text-align: right;"><label class="label label-warning"><?php echo CitruscartHelperBase::currency( $stats->thismonth->average,'', $options_decimal ); ?></label></td>
...
<tr>
	...
	<td style="text-align: right;"><label class="label label-warning"><?php echo CitruscartHelperBase::currency( $stats->lastyear->average,'', $options_decimal ); ?></label></td>
...
<tr>
	...
	<td style="text-align: right;"><label class="label label-warning"><?php echo CitruscartHelperBase::currency( $stats->thisyear->average,'', $options_decimal ); ?></label></td>
...
<tr>
	...
	<td style="text-align: right;"><label class="label label-warning"><?php echo CitruscartHelperBase::currency( $stats->lifetime->average,'', $options_decimal ); ?></label></td>
