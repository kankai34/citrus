...
class CitruscartHelperImage extends CitruscartHelperBase
{
	...
	function resize($name, $type = 'product', $options = array()){
		...
		JImport( 'com_citruscart.library.image', JPATH_ADMINISTRATOR . 'components' );
		$img = new CitruscartImage($name);
	 ...
	 * Resize Image
	 * 
	 * @param image	CitruscartImage	filename of the image
	 * @param type	string	what kind of image: product, category
