...
class JFakeElementCitruscartManufacturer extends JFakeElementBase
{

		
	var	$_name = 'CitruscartManufacturer';
...
if(version_compare(JVERSION,'1.6.0','ge')) {
	class JFormFieldCitruscartManufacturer extends JFakeElementCitruscartManufacturer {}
} else {
	class JElementCitruscartManufacturer extends JFakeElementCitruscartManufacturer {}
}
