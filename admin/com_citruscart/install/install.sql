...
-- -----------------------------------------------------
-- Table `#__citruscart_config`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_config` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_countries` (
...
-- -----------------------------------------------------
-- Dumping data for table `#__citruscart_countries`
-- -----------------------------------------------------

INSERT IGNORE INTO `#__citruscart_countries` (`country_id`, `country_name`, `country_isocode_2`, `country_isocode_3`) VALUES
...
INSERT IGNORE INTO `#__citruscart_countries` (`country_id`, `country_name`, `country_isocode_2`, `country_isocode_3`, `ordering`) VALUES
...
CREATE TABLE  IF NOT EXISTS `#__citruscart_eavattributes` (
...
CREATE TABLE  IF NOT EXISTS `#__citruscart_eavattributeentityxref` (
`eavattribute_id` INT NOT NULL,
`eaventity_id` INT NOT NULL,
`eaventity_type` VARCHAR( 255 ) NOT NULL COMMENT  'For citruscart: if eavattribute is for products, this could be product, category, etc',
...
-- -----------------------------------------------------
-- Table `#__citruscart_eavattributeoptions`
-- -----------------------------------------------------

CREATE TABLE  IF NOT EXISTS `#__citruscart_eavattributeoptions` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_eavvaluesvarchar`
-- -----------------------------------------------------

CREATE TABLE  IF NOT EXISTS `#__citruscart_eavvaluesvarchar` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_eavvaluesint`
-- -----------------------------------------------------

CREATE TABLE  IF NOT EXISTS `#__citruscart_eavvaluesint` (
`eavvalue_id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`eavattribute_id` INT NOT NULL ,
`eaventity_type` VARCHAR( 255 ) NOT NULL COMMENT 'table name of the entity',
`eaventity_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `#__citruscart_eavvaluestext`
-- -----------------------------------------------------

CREATE TABLE  IF NOT EXISTS `#__citruscart_eavvaluestext` (
`eavvalue_id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`eavattribute_id` INT NOT NULL ,
`eaventity_type` VARCHAR( 255 ) NOT NULL COMMENT 'table name of the entity',
`eaventity_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `#__citruscart_eavvaluesdatetime`
-- -----------------------------------------------------

CREATE TABLE  IF NOT EXISTS `#__citruscart_eavvaluesdatetime` (
`eavvalue_id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`eavattribute_id` INT NOT NULL ,
`eaventity_type` VARCHAR( 255 ) NOT NULL COMMENT 'table name of the entity',
`eaventity_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `#__citruscart_eavvaluesdecimal`
-- -----------------------------------------------------

CREATE TABLE  IF NOT EXISTS `#__citruscart_eavvaluesdecimal` (
`eavvalue_id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`eavattribute_id` INT NOT NULL ,
`eaventity_type` VARCHAR( 255 ) NOT NULL COMMENT 'table name of the entity',
`eaventity_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `#__citruscart_geozones`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_geozones` (
  `geozone_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `geozone_name` VARCHAR(32) NOT NULL DEFAULT '' ,
  `geozone_description` TEXT NULL ,
  ...
  CONSTRAINT `fk_geozonetype`
    ...
    REFERENCES `#__citruscart_geozonetypes` (`geozonetype_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `#__citruscart_geozonetypes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_geozonetypes` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_manufacturers` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_taxclasses` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_taxrates` (
  ...
  CONSTRAINT `fk_TaxClass_TaxRates`
    ...
    REFERENCES `#__citruscart_taxclasses` (`tax_class_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_geozones_taxrates`
    FOREIGN KEY (`geozone_id` )
    REFERENCES `#__citruscart_geozones` (`geozone_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_carts` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_categories` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_currencies` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_orderstates`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_orderstates` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_orders` (
  ...
  `anonymous` TINYINT(1) NOT NULL DEFAULT '0' COMMENT 'allows for processing descret orders, or anoyomous donations',
  `app_fee` DECIMAL(10,2) NULL DEFAULT '0.00' ,
  ...
  CONSTRAINT `fk_OrderState_Order`
    ...
    REFERENCES `#__citruscart_orderstates` (`order_state_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_currencies_orders`
    FOREIGN KEY (`currency_id` )
    REFERENCES `#__citruscart_currencies` (`currency_id` )
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_orderhistory` (
  ...
  CONSTRAINT `fk_Orders_OrderHistory`
    ...
    REFERENCES `#__citruscart_orders` (`order_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_productquantities`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `#__citruscart_productquantities` (
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_productattributes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productattributes` (
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_productattributeoptions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productattributeoptions` (
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_productattributeoptionvalues`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productattributeoptionvalues` (
  ...
  CONSTRAINT `fk_paov_pao`
    ...
    REFERENCES `#__citruscart_productattributeoptions` (`productattributeoption_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) 
ENGINE = InnoDB
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_products` (
...
-- --------------------------------------------------------
-- Table structure for table `#__citruscart_orderitemattributes`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `#__citruscart_orderitemattributes` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_orderitems` (
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_ordervendors`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `#__citruscart_ordervendors` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_ordertaxclasses`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_ordertaxclasses` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_ordertaxrates` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_orderpayments`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_orderpayments` (
...
CREATE TABLE IF NOT EXISTS `#__citruscart_ordershippings` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_ordercoupons`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_ordercoupons` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_orderinfo` (
  `orderinfo_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `order_id` INT(11) NOT NULL DEFAULT '0' ,
  `billing_company` VARCHAR(64) NULL DEFAULT NULL ,
  `billing_last_name` VARCHAR(32) NULL DEFAULT NULL ,
  `billing_first_name` VARCHAR(32) NULL DEFAULT NULL ,
  `billing_middle_name` VARCHAR(32) NULL DEFAULT NULL ,
  `billing_phone_1` VARCHAR(32) NULL DEFAULT NULL ,
  `billing_phone_2` VARCHAR(32) NULL DEFAULT NULL ,
  `billing_fax` VARCHAR(32) NULL DEFAULT NULL ,
  ...
  `shipping_middle_name` VARCHAR(32) NULL DEFAULT NULL ,
  `shipping_phone_1` VARCHAR(32) NULL DEFAULT NULL ,
  `shipping_phone_2` VARCHAR(32) NULL DEFAULT NULL ,
  `shipping_fax` VARCHAR(32) NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `#__citruscart_productcategoryxref`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_productcategoryxref` (
  ...
  CONSTRAINT `fk_Category_ProductCategory`
    ...
    REFERENCES `#__citruscart_categories` (`category_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_groups` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_usergroupxref`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_usergroupxref` (
  ...
  CONSTRAINT `fk_Group_UserGroup`
    ...
    REFERENCES `#__citruscart_groups` (`group_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `#__citruscart_productdownloads`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productdownloads` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productfiles` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_productdownloadlogs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productdownloadlogs` (
  ...
  CONSTRAINT `fk_ProductFile_ProductDownloadLog`
    ...
    REFERENCES `#__citruscart_productfiles` (`productfile_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productprices` (
  `product_price_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `product_id` INT(11) NOT NULL DEFAULT '0' ,
  `product_price` DECIMAL(12,5) NULL DEFAULT '0.00' ,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_shippingmethods` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_shippingrates` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_userinfo` (
  ...
  `phone_1` VARCHAR(32) NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_addresses` (
  `address_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `user_id` INT(11) NOT NULL DEFAULT '0' ,
  `addresstype_id` INT(2) NULL ,
  ...
  `address_2` VARCHAR(64) NULL DEFAULT NULL ,
  ...
  CONSTRAINT `fk_addresses_countries`
    ...
    REFERENCES `#__citruscart_countries` (`country_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_zones_addresses`
    FOREIGN KEY (`zone_id` )
    REFERENCES `#__citruscart_zones` (`zone_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- --------------------------------------------------------
-- Table structure for table `#__citruscart_zones`
-- --------------------------------------------------------

CREATE TABLE IF NOT EXISTS `#__citruscart_zones` (
...
-- --------------------------------------------------------
-- Dumping data for table `#__citruscart_groups`
-- --------------------------------------------------------

INSERT IGNORE INTO `#__citruscart_groups` (`group_id`, `group_name`, `group_description`, `created_date`, `modified_date`) VALUES
(1, 'Default', '<p>Default</p>', '2010-09-19 10:27:00', '2010-09-19 10:27:03');

-- --------------------------------------------------------
-- Dumping data for table `#__citruscart_zones`
-- --------------------------------------------------------

INSERT IGNORE INTO `#__citruscart_zones` (`zone_id`, `country_id`, `code`, `zone_name`) VALUES
(1, 1, 'BDS', 'Badakhshan'),
(2, 1, 'BDG', 'Badghis'),
(3, 1, 'BGL', 'Baghlan'),
(4, 1, 'BAL', 'Balkh'),
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_zonerelations` (
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_subscriptions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_subscriptions` (
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_subscriptionhistory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_subscriptionhistory` (
...
DROP TABLE IF EXISTS `#__citruscart_productvotes`;

-- -----------------------------------------------------
-- Table structure for table `#__citruscart_productcomments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productcomments` (
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_productcommentshelpfulness`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productcommentshelpfulness` (
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_coupons`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_coupons` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_credits`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_credits` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_credittypes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__citruscart_credittypes` (
...
-- -----------------------------------------------------
-- Dumping data for table `#__citruscart_credittypes`
-- -----------------------------------------------------
INSERT IGNORE INTO `#__citruscart_credittypes` (`credittype_id`, `credittype_code`, `credittype_name`) VALUES
(1, 'refund', 'Refund'),
(2, 'coupon', 'Coupon'),
...
-- -----------------------------------------------------
-- Table structure for table `#__citruscart_productcompare`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productcompare` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_productcouponxref`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productcouponxref` (
  ...
  CONSTRAINT `fk_Coupon_ProductCoupon`
    ...
    REFERENCES `#__citruscart_coupons` (`coupon_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_productissues` (
...
-- -----------------------------------------------------
-- Table `#__citruscart_posrequests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__citruscart_posrequests` (
