    ...
    <div id="product_files">
        ...
        <div class="productfile">
            <span class="productfile_image">
                <a href="<?php echo JRoute::_( 'index.php?option=com_citruscart&view=products&task=downloadfile&format=raw&id='.$item->productfile_id."&product_id=".$vars->product_id); ?>">
            ...
            <span class="productfile_link" style="vertical-align: middle;" >
                <a href="<?php echo JRoute::_( 'index.php?option=com_citruscart&view=products&task=downloadfile&format=raw&id='.$item->productfile_id."&product_id=".$vars->product_id); ?>"><?php echo $item->productfile_name; ?></a>
            </span>
        </div>
        <?php $k = 1 - $k; ?>
        <?php endforeach;
