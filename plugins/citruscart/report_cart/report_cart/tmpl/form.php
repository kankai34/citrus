...
<?php // echo JText::_('COM_CITRUSCART_THIS_REPORTS_ON_TOTAL_NUMBER_OF_CARTS_IN_EACH_PRODUCT'); ?>
<div class="navbar">
  <div class="navbar-inner">
    ...
    <ul class="nav navbar-form pull-left">
    	 ...
    	 <li ><input type="text" name="filter_name" placeholder="<?php echo JText::_('COM_CITRUSCART_PRODUCT_NAME'); ?>" id="filter_name" value="<?php echo $state->filter_name; ?>" /></li>
    	 <li class="divider-vertical"></li>
